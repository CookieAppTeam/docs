...
1.  **The following requirements are available:**
    - Require a specific role
    - Exclude a role
    - Limit to users without Nitro
    - Require message activity in the past X days
    - Require voice activity in the past X days
    - Require account age
    - Require server join date

![Giveaway Setup](https://cdn.cookieapp.me/docs/giveaway/setup.png){ width="450" }
/// caption
