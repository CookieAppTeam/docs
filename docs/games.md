...
!!! tip "Games in Private Chats"
    ...
    [Add Cookie to your Discord account](index.md#invite) to get started.
...
- 🎲 **Numbers** - Count using regular numbers. (1)
- 🏛️ **Roman** - Count using Roman numerals. (2)
- 💻 **Binary** - Count using binary numbers. (3)
- 🧮 **Mathematical** - Count using simple math expressions. (4)

You can also choose what happens on a wrong count:

- 🗑️ **Delete** - The wrong message is deleted.
- ❌ **Reset** - The count resets to 1.
- 🛑 **Blacklist** - The user is blacklisted from counting for a configurable time.
...
---
![Tic Tac Toe](https://cdn.cookieapp.me/docs/games/tictactoe.png){ align=right width="220" }

## ⭕ Tic Tac Toe
Tic Tac Toe is a classic two-player game where players take turns marking spaces in a grid.

- Use `/game tictactoe` to start a new game.
- The first player to get three of their marks in a row (horizontally, vertically, or diagonally)
wins!

---
![Rock Paper Scissors](https://cdn.cookieapp.me/docs/games/rps.png){ align=right width="220" }

## ✊️ Rock Paper Scissors
Rock Paper Scissors can be played with a friend or against the bot.

- Use `/game rps` to start a new game. You can choose how many rounds to play.
- The player who wins the required number of rounds first wins the game!
